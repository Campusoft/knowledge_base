...
MassTransit es un framework open-source para construir aplicaciones distribuidas en .NET utilizando mensajería (message-based architecture).

No es un broker.
Es una capa de abstracción sobre brokers de mensajería como:
...
Permite implementar patrones como:
